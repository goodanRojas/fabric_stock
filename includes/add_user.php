...
if (isset($_POST['upload'])) {
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
        ...
        $stmt = $conn->prepare("INSERT INTO users (type_of_user, firstname, lastname, email, contact, image_name, pwd) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("issssss", $user_type, $firstname, $lastname, $email, $contact, $image, $pass);
